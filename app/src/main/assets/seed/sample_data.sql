...
-- IMPORTANTE: la lista de columnas debe cubrir todas las columnas NOT NULL de la entidad
-- WorkOrder (los valores por defecto de Kotlin no generan DEFAULT en SQL). Si se agrega un
-- campo NOT NULL a la entidad, hay que agregarlo aquí o la carga de ejemplos falla completa.
-- Los totales deben cuadrar con las líneas que este archivo inserta más abajo.
INSERT INTO work_orders (id, vehicleId, customerId, entryDate, status, priority, orderType, arrivalCondition, customerComplaint, initialDiagnosis, assignedMechanicId, entryMileage, fuelLevel, checklistNotes, totalLabor, totalParts, totalExtras, total, photoPaths, filePaths, deliveryNote, invoiceNumber, notes, createdBy, updatedBy, createdAt, updatedAt) VALUES (1, 1, 2, 1772486177187, 'LISTO', 'MEDIA', 'SERVICIO_NUEVO', 'RODANDO', 'CAMBIO DE ACEITE Y FILTRO', 'CAMBIO DE ACEITE Y FILTRO', NULL, 45000, '3/4', NULL, 5.0, 0.0, 0.0, 5.0, NULL, NULL, NULL, NULL, NULL, 1, 1, 1772486177187, 1772486177187);

-- Order 2: Frenos - EN_PROCESO (vehicle 3, customer 4)
INSERT INTO work_orders (id, vehicleId, customerId, entryDate, status, priority, orderType, arrivalCondition, customerComplaint, initialDiagnosis, assignedMechanicId, entryMileage, fuelLevel, checklistNotes, totalLabor, totalParts, totalExtras, total, photoPaths, filePaths, deliveryNote, invoiceNumber, notes, createdBy, updatedBy, createdAt, updatedAt) VALUES (2, 3, 4, 1772486177187, 'EN_PROCESO', 'ALTA', 'SERVICIO_NUEVO', 'RODANDO', 'RUIDO AL FRENAR', 'PASTILLAS DE FRENO DESGASTADAS', NULL, 78000, '1/2', NULL, 25.0, 0.0, 0.0, 25.0, NULL, NULL, NULL, NULL, NULL, 1, 1, 1772486177187, 1772486177187);

-- Order 3: Mantenimiento completo - RECIBIDO (vehicle 5, customer 6)
INSERT INTO work_orders (id, vehicleId, customerId, entryDate, status, priority, orderType, arrivalCondition, customerComplaint, initialDiagnosis, assignedMechanicId, entryMileage, fuelLevel, checklistNotes, totalLabor, totalParts, totalExtras, total, photoPaths, filePaths, deliveryNote, invoiceNumber, notes, createdBy, updatedBy, createdAt, updatedAt) VALUES (3, 5, 6, 1772486177187, 'RECIBIDO', 'MEDIA', 'SERVICIO_NUEVO', 'RODANDO', 'MANTENIMIENTO 90000 KMS', NULL, NULL, 95000, '1/4', NULL, 0.0, 0.0, 0.0, 0.0, NULL, NULL, NULL, NULL, NULL, 1, 1, 1772486177187, 1772486177187);
